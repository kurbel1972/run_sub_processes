...
logging.basicConfig(
    filename='send_files_cs_to_bk.log', 
    level=logging.DEBUG,
...
source = r'P:\Exportacao\EXP-CAU\Inbox\CertificadoSaida\Processados'
destination = r'P:\Exportacao\EXP-CAU\Inbox\CertificadoSaida\Processados\2026\Abril'
counter_files = 0
...
for file in files:
    if file.startswith('CertifSaida_Exp_202604'):
        counter_files += 1
